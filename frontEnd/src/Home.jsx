...
export default function Home() {
  ...
  const groupNumber = 7;
  const groupLatestDevicesStatusData = Array.from({ length: Math.ceil(latestDevicesStatusData.length / groupNumber) }, (_, index) => (
